...
$con = mysqli_connect('localhost','root','bhavna','product_details');
?>
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
    ...
    <div class="container padding">
        <?php
            $query = "SELECT * FROM specialchicken ORDER BY id ASC";
            ...
            ?>
                <div class="col-md-4">
                    <form method="POST" action="specialchicken.php?action=add&id=<?php echo $row["id"]; ?>" onsubmit = "alert('Item Added')" >
